...
const defineParams = {
  ...
  betAmount: { type: DataTypes.DECIMAL(19, 2), defaultValue: 0 },
  validBetAmount: { type: DataTypes.DECIMAL(19, 2), defaultValue: 0 },
  winAmount: { type: DataTypes.DECIMAL(19, 2), defaultValue: 0 },
  netPnl: { type: DataTypes.DECIMAL(19, 2), defaultValue: 0 },
